...
![alt-text-1](https://github.com/sgoldenlab/simba/blob/master/images/Multi_crop.gif "Multi_crop_1")
...
6. The cropped output videos will be located in the user-defined *Output folder* defined in Step 3. 
